...
export default function AboutPage() {
  return <>
    ...
    <section className="section"><div className="section-heading"><p className="eyebrow">Our partners</p><h2>A collaborative national effort.</h2><p className="section-deck">Organizations contribute complementary expertise in research, higher education, writing, technology, evaluation, and national leadership.</p></div><div className="partner-grid large-partners">{partners.map((partner)=><Link className="partner-link" href={partner.href} target="_blank" rel="noreferrer" key={partner.name}>{partner.name}<b aria-hidden="true">↗</b></Link>)}</div></section>

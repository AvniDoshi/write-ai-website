  ...
  return <>
    ...
    <section className="section people-directory">
      ...
      <div className="organization-sections">
        ...
        <section className="organization-section" id="partner-organizations"><h2>Partner Organizations</h2><div className="partner-grid large-partners">{partnerOrganizations.map((partner) => <Link className="partner-link" href={partner.href} target="_blank" rel="noreferrer" key={partner.name}>{partner.name}<b aria-hidden="true">↗</b></Link>)}</div></section>
      </div>
    </section>
  </>;
}
